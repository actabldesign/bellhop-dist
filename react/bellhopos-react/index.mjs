...
const PageNavigationChild$1 = ({ label, badge, showBadge = true, isActive = false, onItemClick, className = '', }) => {
    ...
    return (jsx("div", { className: itemClasses, onClick: handleClick, children: jsxs("div", { className: "page-navigation-child-content", children: [jsx("span", { className: "page-navigation-child-label", children: label }), badge && showBadge && (jsx(Badge, { label: String(badge), size: "sm", type: "neutral", emphasis: "medium" }))] }) }));
};
