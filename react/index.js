...
const PageNavigationChild$1 = ({ label, badge, showBadge = true, isActive = false, onItemClick, className = '', }) => {
    ...
    return (jsxRuntime.jsx("div", { className: itemClasses, onClick: handleClick, children: jsxRuntime.jsxs("div", { className: "page-navigation-child-content", children: [jsxRuntime.jsx("span", { className: "page-navigation-child-label", children: label }), badge && showBadge && (jsxRuntime.jsx(Badge, { label: String(badge), size: "sm", type: "neutral", emphasis: "medium" }))] }) }));
};
...
const PieChartCard = ({ breakpoint = 'desktop', data, hole = '85%', size = 160, animated = true, gap = 5, showDropdown = true, dropdownVariant = 'icon-only-ghost', showFooter = false, footerButtonLabel = 'View report', showLegend = true, onDropdownSelect, onFooterButtonClick, }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: "pie-chart-card-wrapper", children: [jsxRuntime.jsxs("div", { className: containerClasses, children: [showDropdown && (jsxRuntime.jsx("div", { className: "pie-chart-card-dropdown", children: jsxRuntime.jsx(Dropdown, { variant: dropdownVariant, size: "md", iconName: "more_vert", menuItems: defaultDropdownMenuItems$1, onItemClick: handleDropdownSelect }) })), jsxRuntime.jsxs("div", { className: "pie-chart-card-header", children: [jsxRuntime.jsx("h3", { className: "pie-chart-card-heading", children: data.title }), jsxRuntime.jsx("p", { className: "pie-chart-card-subtitle", children: data.subtitle })] }), jsxRuntime.jsx("div", { className: "pie-chart-card-content", children: jsxRuntime.jsxs("div", { className: "chart-and-legend-container", children: [jsxRuntime.jsx("div", { className: "pie-chart-container", children: jsxRuntime.jsxs("div", { className: "chart-wrapper", children: [jsxRuntime.jsx(PieChart, { data: data.chartData, hole: hole, size: size, animated: animated, gap: gap }), jsxRuntime.jsxs("div", { className: `chart-center-content ${animated ? 'animated' : ''}`, children: [jsxRuntime.jsx("div", { className: "chart-center-value", children: data.value }), data.badge && (jsxRuntime.jsx("div", { className: "chart-center-badge-container", children: jsxRuntime.jsx(Badge, { variant: "green", size: "sm", emphasis: "medium", icon: "trending_up", label: data.badge }) }))] })] }) }), showLegend && legendItems.length > 0 && (jsxRuntime.jsx("div", { className: "pie-chart-card-legend", children: legendItems.map((item, index) => (jsxRuntime.jsxs("div", { className: "legend-item", children: [jsxRuntime.jsx("div", { className: "legend-color", style: { backgroundColor: item.color } }), jsxRuntime.jsxs("div", { className: "legend-content", children: [jsxRuntime.jsx("span", { className: "legend-text", children: item.name }), item.percentage && (jsxRuntime.jsx("div", { className: "legend-values", children: jsxRuntime.jsx("span", { className: "legend-percentage", children: item.percentage }) }))] })] }, index))) }))] }) })] }), showFooter && (jsxRuntime.jsx(ContainerFooter, { size: "standard", buttonLabel: footerButtonLabel, onButtonClick: handleFooterButtonClick }))] }));
};
