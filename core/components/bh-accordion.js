...
const BhAccordion$1 = /*@__PURE__*/ proxyCustomElement(class BhAccordion extends H {
    constructor(registerHost) {
        ...
        this.__attachShadow();
        this.bhAccordionChange = createEvent(this, "bhAccordionChange");
    }
    /**
    ...
    static get style() { return bhAccordionCss; }
}, [769, "bh-accordion", {
        "mode": [1],
        "value": [1025],
        "collapsible": [4],
        "expandedItems": [32]
    }, [[0, "bhAccordionToggle", "handleAccordionToggle"]], {
        "value": ["handleValueChange"]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["bh-accordion"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-accordion":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhAccordion$1);
            }
            break;
    } });
}
...
const BhAccordion = BhAccordion$1;
const defineCustomElement = defineCustomElement$1;

export { BhAccordion, defineCustomElement };
