...
import { d as defineCustomElement$8 } from './p-X9MH3dtg.js';
import { d as defineCustomElement$7 } from './p-YJm8-pxX.js';
import { d as defineCustomElement$6 } from './p-D3OkBDd3.js';
import { d as defineCustomElement$5 } from './p-Dbl0HXBJ.js';
import { d as defineCustomElement$4 } from './p-MIbEYjCv.js';
import { d as defineCustomElement$3 } from './p-CDPKBnfQ.js';
...
const BhInputAutocomplete$1 = /*@__PURE__*/ proxyCustomElement(class BhInputAutocomplete extends H {
    ...
    render() {
        ...
        return (h(Host, { key: '61d319d2ad6a9fad1067d017602b4ec3e856c62d' }, h("div", { key: '1fd6c5019c2abde42bddbf604087183e9a0355be', class: "input-autocomplete-wrapper", style: { width: this.width }, onKeyDown: this.handleKeyDown }, this.multiSelect ? (
        ...
        h("bh-input-text", { state: this.getInputTextState(), error: this.error, required: this.required, disabled: this.disabled, showHelpIcon: this.showHelpIcon, showLeadingIcon: this.showLeadingIcon, showLabel: this.showLabel, showHintText: this.showHintText, label: this.label, placeholder: this.placeholder, hintText: this.hintText, leadingIcon: this.leadingIcon, helpIconTooltip: this.helpIconTooltip, value: this.value, width: "100%", onBhInput: (e) => {
            ...
            }, onBhFocus: this.handleInputFocus, onBhBlur: this.handleInputBlur, onBhHelpClick: () => this.bhHelpClick.emit() })), h("bh-autocomplete-menu", { key: 'a6a4e0692cb97555257ac794a090275533ff5dd7', visible: this.showDropdown, menuItems: this.filteredOptions, selectedIndex: this.focusedOptionIndex, multiSelect: this.multiSelect, searchQuery: this.value, onBhItemClick: this.handleOptionSelect, onBhItemHover: this.handleItemHover }))));
    }
    static get watchers() { return {
        "value": ["handleValueChange"]
    }; }
    static get style() { return bhInputAutocompleteCss; }
}, [769, "bh-input-autocomplete", {
        "state": [1],
        "error": [4],
        "required": [4],
        "disabled": [4],
...
function defineCustomElement$1() {
    ...
    const components = ["bh-input-autocomplete", "bh-autocomplete-menu", "bh-avatar", "bh-button-icon", "bh-input-text", "bh-label", "bh-tag", "bh-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-input-autocomplete":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhInputAutocomplete$1);
            }
            break;
...
const BhInputAutocomplete = BhInputAutocomplete$1;
const defineCustomElement = defineCustomElement$1;

export { BhInputAutocomplete, defineCustomElement };
