...
const BhAvatarAdd = /*@__PURE__*/ proxyCustomElement(class BhAvatarAdd extends H {
    ...
    static get style() { return bhAvatarAddCss; }
}, [769, "bh-avatar-add", {
        "size": [1],
        "disabled": [4],
...
function defineCustomElement() {
    ...
    const components = ["bh-avatar-add", "bh-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-avatar-add":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhAvatarAdd);
            }
            break;
        case "bh-tooltip":
            if (!customElements.get(tagName)) {
...
//# sourceMappingURL=p-p8W0xKpn.js.map
