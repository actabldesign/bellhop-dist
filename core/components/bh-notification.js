...
import { d as defineCustomElement$3 } from './p-D6cM-mvE.js';
...
const BhNotification$1 = /*@__PURE__*/ proxyCustomElement(class BhNotification extends H {
    ...
    static get style() { return bhNotificationCss; }
}, [769, "bh-notification", {
        "type": [1],
        "notificationTitle": [1, "notification-title"],
        "description": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["bh-notification", "bh-button", "bh-featured-icon", "bh-loader-spinner"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-notification":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhNotification$1);
            }
            break;
        case "bh-button":
            if (!customElements.get(tagName)) {
...
const BhNotification = BhNotification$1;
const defineCustomElement = defineCustomElement$1;

export { BhNotification, defineCustomElement };
