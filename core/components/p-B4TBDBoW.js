...
const BhPageNavigationChild = /*@__PURE__*/ proxyCustomElement(class BhPageNavigationChild extends H {
    ...
    static get style() { return bhPageNavigationChildCss; }
}, [769, "bh-page-navigation-child", {
        "label": [1],
        "badge": [8],
...
function defineCustomElement() {
    ...
    const components = ["bh-page-navigation-child"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-page-navigation-child":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhPageNavigationChild);
            }
            break;
    } });
}
...
//# sourceMappingURL=p-B4TBDBoW.js.map
