...
const BhProductSwitcher = /*@__PURE__*/ proxyCustomElement(class BhProductSwitcher extends H {
    ...
    static get style() { return bhProductSwitcherCss; }
}, [769, "bh-product-switcher", {
        "isOpen": [4, "is-open"],
        "anchorPosition": [16],
        "products": [16],
        "isClosing": [32]
...
function defineCustomElement() {
    ...
    const components = ["bh-product-switcher"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-product-switcher":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhProductSwitcher);
            }
            break;
    } });
}
...
export { BhProductSwitcher as B, defineCustomElement as d };
//# sourceMappingURL=p-HEcFS8Jc.js.map
