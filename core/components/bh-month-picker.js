...
import { d as defineCustomElement$8 } from './p-DTgHvmlL.js';
...
const BhMonthPicker$1 = /*@__PURE__*/ proxyCustomElement(class BhMonthPicker extends H {
    ...
    static get style() { return bhMonthPickerCss; }
}, [769, "bh-month-picker", {
        "variant": [1],
        "minYear": [2, "min-year"],
        "maxYear": [2, "max-year"],
...
function defineCustomElement$1() {
    ...
    const components = ["bh-month-picker", "bh-button", "bh-input-text", "bh-label", "bh-loader-spinner", "bh-month-picker-content", "bh-picker-menu", "bh-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-month-picker":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhMonthPicker$1);
            }
            break;
        case "bh-button":
            if (!customElements.get(tagName)) {
...
const BhMonthPicker = BhMonthPicker$1;
const defineCustomElement = defineCustomElement$1;

export { BhMonthPicker, defineCustomElement };
