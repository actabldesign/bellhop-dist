...
const BhBarChart$1 = /*@__PURE__*/ proxyCustomElement(class BhBarChart extends H {
    ...
    static get style() { return bhBarChartCss; }
}, [769, "bh-bar-chart", {
        "data": [16],
        "type": [1],
        "orientation": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["bh-bar-chart", "bh-chart-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-bar-chart":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhBarChart$1);
            }
            break;
...
const BhBarChart = BhBarChart$1;
const defineCustomElement = defineCustomElement$1;

export { BhBarChart, defineCustomElement };
