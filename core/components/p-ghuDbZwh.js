...
const BhDropdownMenu = /*@__PURE__*/ proxyCustomElement(class BhDropdownMenu extends H {
    ...
    static get style() { return bhDropdownMenuCss; }
}, [769, "bh-dropdown-menu", {
        "header": [1],
...
function defineCustomElement() {
    ...
    const components = ["bh-dropdown-menu", "bh-avatar"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-dropdown-menu":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhDropdownMenu);
            }
            break;
        case "bh-avatar":
            if (!customElements.get(tagName)) {
...
//# sourceMappingURL=p-ghuDbZwh.js.map
