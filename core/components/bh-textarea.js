...
const BhTextarea$1 = /*@__PURE__*/ proxyCustomElement(class BhTextarea extends H {
    ...
    static get style() { return bhTextareaCss; }
}, [833, "bh-textarea", {
        "label": [1],
        "placeholder": [1],
...
function defineCustomElement$1() {
    ...
    const components = ["bh-textarea", "bh-label", "bh-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-textarea":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhTextarea$1);
            }
            break;
        case "bh-label":
            if (!customElements.get(tagName)) {
...
const BhTextarea = BhTextarea$1;
const defineCustomElement = defineCustomElement$1;

export { BhTextarea, defineCustomElement };
