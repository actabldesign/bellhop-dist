...
const BhCheckbox = /*@__PURE__*/ proxyCustomElement(class BhCheckbox extends H {
    ...
    static get style() { return bhCheckboxCss; }
}, [833, "bh-checkbox", {
        "size": [1],
        "checked": [1540],
        "indeterminate": [1028],
...
function defineCustomElement() {
    ...
    const components = ["bh-checkbox", "bh-label", "bh-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-checkbox":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhCheckbox);
            }
            break;
        case "bh-label":
            if (!customElements.get(tagName)) {
...
//# sourceMappingURL=p-BBenNW93.js.map
