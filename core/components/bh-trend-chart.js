...
const BhTrendChart$1 = /*@__PURE__*/ proxyCustomElement(class BhTrendChart extends H {
    ...
    static get style() { return bhTrendChartCss; }
}, [769, "bh-trend-chart", {
        "trend": [1],
        "data": [16],
        "animated": [4],
...
function defineCustomElement$1() {
    ...
    const components = ["bh-trend-chart"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-trend-chart":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhTrendChart$1);
            }
            break;
    } });
}
...
const BhTrendChart = BhTrendChart$1;
const defineCustomElement = defineCustomElement$1;

export { BhTrendChart, defineCustomElement };
