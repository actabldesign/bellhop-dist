...
const BhButtonIcon = /*@__PURE__*/ proxyCustomElement(class BhButtonIcon extends H {
    ...
    static get style() { return bhButtonIconCss; }
}, [769, "bh-button-icon", {
        "hierarchy": [1],
        "size": [1],
...
function defineCustomElement() {
    ...
    const components = ["bh-button-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-button-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhButtonIcon);
            }
            break;
    } });
}
...
//# sourceMappingURL=p-D3OkBDd3.js.map
