...
const BhFeaturedIcon = /*@__PURE__*/ proxyCustomElement(class BhFeaturedIcon extends H {
    ...
    static get style() { return bhFeaturedIconCss; }
}, [769, "bh-featured-icon", {
        "size": [1],
        "color": [1],
...
function defineCustomElement() {
    ...
    const components = ["bh-featured-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-featured-icon":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhFeaturedIcon);
            }
            break;
    } });
}
...
export { BhFeaturedIcon as B, defineCustomElement as d };
//# sourceMappingURL=p-D6cM-mvE.js.map
