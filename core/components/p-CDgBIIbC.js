...
const BhMonthPickerContent = /*@__PURE__*/ proxyCustomElement(class BhMonthPickerContent extends H {
    ...
    render() {
        ...
        return (h(Host, { key: 'aa0bf635ddc8fffb3d21e705595e87ce4a60acea' }, h("div", { key: '0df1d3fed84f43c412e3c66becc237cdc5b8def0', class: `month-picker-content animate-slide-up-enter ${this.scrollable ? 'scrollable' : ''}`, style: { height: this.height }, onKeyDown: this.handleKeyDown, onMouseDown: this.handleMouseDown }, h("div", { key: '9745606dcf1196dd106f982beacd24ee6f16edaf', class: "calendar" }, years.map((year, yearIndex) => (h("div", { key: year, class: "year-section", id: `year-${year}` }, h("div", { class: "year-month-container" }, h("div", { class: "year-label" }, year), h("div", { class: "months-row" }, h("div", { class: "month-row" }, this.months.slice(0, 6).map((_, monthIndex) => (h("button", { key: monthIndex, class: this.getMonthButtonClasses(monthIndex, year), disabled: !this.isMonthSelectable(monthIndex, year), onClick: () => this.selectMonth(monthIndex, year) }, this.months[monthIndex])))), h("div", { class: "month-row" }, this.months.slice(6, 12).map((_, idx) => {
    ...
    static get style() { return bhMonthPickerContentCss; }
}, [769, "bh-month-picker-content", {
        "minYear": [2, "min-year"],
        "maxYear": [2, "max-year"],
        "disabled": [4],
        "disabledMonths": [16],
        ...
        "height": [1],
        "value": [16],
        "internalSelectedMonth": [32],
        "internalSelectedYear": [32],
        "isUsingKeyboard": [32]
    }, undefined, {
        "value": ["handleValueChange"],
        "selectedMonth": ["handleSelectedMonthChange"],
...
function defineCustomElement() {
    ...
    const components = ["bh-month-picker-content"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-month-picker-content":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhMonthPickerContent);
            }
            break;
    } });
}
...
//# sourceMappingURL=p-CDgBIIbC.js.map
