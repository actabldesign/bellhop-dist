...
import { s as syncCheckableFormValue } from './p-2KjdCYlS.js';
...
const BhRadioButton = /*@__PURE__*/ proxyCustomElement(class BhRadioButton extends H {
    ...
    static get style() { return bhRadioButtonCss; }
}, [833, "bh-radio-button", {
        "size": [1],
        "selected": [1028],
        "disabled": [4],
...
function defineCustomElement() {
    ...
    const components = ["bh-radio-button", "bh-label", "bh-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-radio-button":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhRadioButton);
            }
            break;
        case "bh-label":
            if (!customElements.get(tagName)) {
...
export { BhRadioButton as B, defineCustomElement as d };
//# sourceMappingURL=p-B3doeS-4.js.map
