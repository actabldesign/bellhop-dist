...
import { u as updateValidity } from './p-2KjdCYlS.js';
...
const BhInputNumber$1 = /*@__PURE__*/ proxyCustomElement(class BhInputNumber extends H {
    ...
    static get style() { return bhInputNumberCss; }
}, [833, "bh-input-number", {
        "error": [4],
        "required": [4],
        "disabled": [4],
...
function defineCustomElement$1() {
    ...
    const components = ["bh-input-number", "bh-button-icon", "bh-label", "bh-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-input-number":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhInputNumber$1);
            }
            break;
        case "bh-button-icon":
            if (!customElements.get(tagName)) {
...
const BhInputNumber = BhInputNumber$1;
const defineCustomElement = defineCustomElement$1;

export { BhInputNumber, defineCustomElement };
