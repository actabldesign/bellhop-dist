...
const BhButton = /*@__PURE__*/ proxyCustomElement(class BhButton extends H {
    ...
    static get style() { return bhButtonCss; }
}, [769, "bh-button", {
        "hierarchy": [1],
        "kind": [1],
        "icon": [1],
...
function defineCustomElement() {
    ...
    const components = ["bh-button", "bh-loader-spinner"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-button":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhButton);
            }
            break;
...
export { BhButton as B, defineCustomElement as d };
//# sourceMappingURL=p-DTgHvmlL.js.map
