...
import { d as defineCustomElement$5 } from './p-DTgHvmlL.js';
import { d as defineCustomElement$4 } from './p-D3OkBDd3.js';
import { d as defineCustomElement$3 } from './p-CiQqgc-m.js';
...
const BhDateRangePickerContent = /*@__PURE__*/ proxyCustomElement(class BhDateRangePickerContent extends H {
...
function defineCustomElement() {
    ...
    const components = ["bh-date-range-picker-content", "bh-button", "bh-button-icon", "bh-date-picker-content", "bh-loader-spinner", "bh-month-picker-content"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-date-range-picker-content":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhDateRangePickerContent);
            }
            break;
        case "bh-button":
            if (!customElements.get(tagName)) {
...
//# sourceMappingURL=p-54wXxbeh.js.map
