...
import { d as defineCustomElement$4 } from './p-DRJW4zBc.js';
import { d as defineCustomElement$3 } from './p-Bk8GbEQp.js';
...
const BhAppbar$1 = /*@__PURE__*/ proxyCustomElement(class BhAppbar extends H {
    ...
    static get style() { return bhAppbarCss; }
}, [769, "bh-appbar", {
        "isMenuOpen": [4, "is-menu-open"],
        "logoSrc": [1, "logo-src"],
        "logoAlt": [1, "logo-alt"],
        "breadcrumbItems": [16],
...
function defineCustomElement$1() {
    ...
    const components = ["bh-appbar", "bh-badge-dot", "bh-breadcrumbs", "bh-button-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-appbar":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhAppbar$1);
            }
            break;
        case "bh-badge-dot":
            if (!customElements.get(tagName)) {
...
const BhAppbar = BhAppbar$1;
const defineCustomElement = defineCustomElement$1;

export { BhAppbar, defineCustomElement };
