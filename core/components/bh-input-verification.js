...
const BhInputVerification$1 = /*@__PURE__*/ proxyCustomElement(class BhInputVerification extends H {
    ...
    render() {
        ...
        return (h("div", { key: 'a7068d5407c0d09021313fc6103b5073ca74f628', class: "input-verification-wrapper", style: wrapperStyle }, h("bh-label", { key: '7b62a57a432f3d8f4df7befb87f27a09afeb51fd', label: this.showLabel ? this.label : '', required: this.required, disabled: this.disabled }, h("div", { key: '99cb7311f66b69731dc1d286bd96662c4035affb', class: "input-verification-container" }, this.renderInputs())), this.showHintText && this.hintText && (h("div", { key: '5fbfc4b1f8c3a251a0d879b2554c390126a391c1', class: { 'hint-text': true, 'error': this.error } }, this.hintText))));
    }
    static get watchers() { return {
        "value": ["watchValue"],
        "digits": ["watchDigits"]
    }; }
    static get style() { return bhInputVerificationCss; }
}, [769, "bh-input-verification", {
        "size": [1],
        "digits": [2],
        "label": [1],
        ...
        "disabled": [4],
        "required": [4],
        "showSeparator": [4, "show-separator"],
        "placeholder": [1],
        "width": [1],
        "value": [1025],
        "values": [32],
...
function defineCustomElement$1() {
    ...
    const components = ["bh-input-verification", "bh-label", "bh-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-input-verification":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhInputVerification$1);
            }
            break;
        case "bh-label":
            if (!customElements.get(tagName)) {
...
const BhInputVerification = BhInputVerification$1;
const defineCustomElement = defineCustomElement$1;

export { BhInputVerification, defineCustomElement };
