...
import { d as defineCustomElement$2 } from './p-D6cM-mvE.js';
...
const BhModalHeader$1 = /*@__PURE__*/ proxyCustomElement(class BhModalHeader extends H {
    ...
    static get style() { return bhModalHeaderCss; }
}, [769, "bh-modal-header", {
...
function defineCustomElement$1() {
    ...
    const components = ["bh-modal-header", "bh-button-icon", "bh-featured-icon"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-modal-header":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhModalHeader$1);
            }
            break;
        case "bh-button-icon":
            if (!customElements.get(tagName)) {
...
const BhModalHeader = BhModalHeader$1;
const defineCustomElement = defineCustomElement$1;

export { BhModalHeader, defineCustomElement };
