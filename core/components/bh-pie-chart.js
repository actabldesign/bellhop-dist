...
import { d as defineCustomElement$2 } from './p-BLRNfy0t.js';
...
const BhPieChart$1 = /*@__PURE__*/ proxyCustomElement(class BhPieChart extends H {
    ...
    render() {
        ...
        const innerRadius = this.getInnerRadius();
        return (h(Host, { key: '6e08d27c86b66d352cb0af60a7c53a50bbfdbb68' }, h("div", { key: '6ea7a66cc1294f69e2757f54ace875ebd08613ed', class: "pie-chart-container", style: { width: `${this.size}px`, height: `${this.size}px` } }, h("svg", { key: 'd777cd322d93bf0d419213b87729c2cb94346362', width: this.size, height: this.size, viewBox: "0 0 160 160", class: "pie-chart-svg" }, h("circle", { key: 'bb77a5913fb0d8a849d27bf1e854c1f1ae690c4d', cx: "80", cy: "80", r: "80", fill: "transparent", class: "pie-background" }), segments.map((segment, index) => (h("g", { key: index, class: "pie-segment-group" }, h("path", { d: segment.path, fill: segment.color, class: { 'pie-segment': true, animated: this.animated }, style: { animationDelay: this.animated ? `${index * 0.03}s` : '0s' }, onMouseEnter: (e) => this.handleSegmentHover(e, segment), onMouseLeave: this.handleSegmentLeave })))), this.hole !== 'none' && (h("circle", { key: '00e9cc73e53b04d9cee1df1bcdb2c7b1a2dad5b9', cx: "80", cy: "80", r: innerRadius, fill: "white", class: "pie-inner-hole" })))), h("bh-chart-tooltip", { key: 'a6c2652bf3c556ea6aaa5f8fcd2963abdc8322f6', visible: this.tooltipVisible, x: this.tooltipX, y: this.tooltipY, items: this.tooltipSegment
                ? [
                    {
    ...
    static get style() { return bhPieChartCss; }
}, [769, "bh-pie-chart", {
        "data": [16],
        "hole": [1],
        "size": [2],
...
function defineCustomElement$1() {
    ...
    const components = ["bh-pie-chart", "bh-chart-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-pie-chart":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhPieChart$1);
            }
            break;
...
const BhPieChart = BhPieChart$1;
const defineCustomElement = defineCustomElement$1;

export { BhPieChart, defineCustomElement };
