...
import { d as defineCustomElement$5 } from './p-BBenNW93.js';
import { d as defineCustomElement$4 } from './p-D6cM-mvE.js';
import { d as defineCustomElement$3 } from './p-MIbEYjCv.js';
import { d as defineCustomElement$2 } from './p-B3doeS-4.js';
...
const BhCheckboxGroupItem = /*@__PURE__*/ proxyCustomElement(class BhCheckboxGroupItem extends H {
    ...
    static get style() { return bhCheckboxGroupItemCss; }
}, [769, "bh-checkbox-group-item", {
        "type": [1],
        "size": [1],
        "value": [1],
        "checked": [1028],
...
function defineCustomElement() {
    ...
    const components = ["bh-checkbox-group-item", "bh-checkbox", "bh-featured-icon", "bh-label", "bh-radio-button", "bh-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-checkbox-group-item":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhCheckboxGroupItem);
            }
            break;
        case "bh-checkbox":
            if (!customElements.get(tagName)) {
...
//# sourceMappingURL=p-CErNA5c8.js.map
