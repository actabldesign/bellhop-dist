...
const BhModal = /*@__PURE__*/ proxyCustomElement(class BhModal extends H {
    ...
    static get style() { return bhModalCss; }
}, [769, "bh-modal", {
        "visible": [4],
        "overlay": [4],
        "width": [1]
...
function defineCustomElement() {
    ...
    const components = ["bh-modal"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-modal":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhModal);
            }
            break;
    } });
}
...
//# sourceMappingURL=p-DRGkYX1u.js.map
