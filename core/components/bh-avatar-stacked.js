...
import { d as defineCustomElement$3 } from './p-p8W0xKpn.js';
...
const BhAvatarStacked$1 = /*@__PURE__*/ proxyCustomElement(class BhAvatarStacked extends H {
    ...
    static get style() { return bhAvatarStackedCss; }
}, [769, "bh-avatar-stacked", {
        "size": [1],
        "avatars": [1],
        "maxVisible": [2, "max-visible"],
        "showAddButton": [4, "show-add-button"],
        "addTooltipText": [1, "add-tooltip-text"],
        "hoveredIndex": [32],
        "addButtonHovered": [32]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["bh-avatar-stacked", "bh-avatar", "bh-avatar-add", "bh-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-avatar-stacked":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhAvatarStacked$1);
            }
            break;
        case "bh-avatar":
            if (!customElements.get(tagName)) {
...
const BhAvatarStacked = BhAvatarStacked$1;
const defineCustomElement = defineCustomElement$1;

export { BhAvatarStacked, defineCustomElement };
