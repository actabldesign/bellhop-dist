...
const BhIllustrations$1 = /*@__PURE__*/ proxyCustomElement(class BhIllustrations extends H {
    ...
    static get style() { return bhIllustrationsCss; }
}, [769, "bh-illustrations", {
        "size": [1],
        "illustrationTitle": [1, "illustration-title"],
        "description": [1],
        "svgPath": [1, "svg-path"],
        "alt": [1]
    }]);
function defineCustomElement$1() {
    ...
    const components = ["bh-illustrations"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-illustrations":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhIllustrations$1);
            }
            break;
    } });
}
...
const BhIllustrations = BhIllustrations$1;
const defineCustomElement = defineCustomElement$1;

export { BhIllustrations, defineCustomElement };
