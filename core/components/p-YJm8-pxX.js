...
const BhAvatar = /*@__PURE__*/ proxyCustomElement(class BhAvatar extends H {
    ...
    static get style() { return bhAvatarCss; }
}, [769, "bh-avatar", {
        "size": [1],
        "type": [1],
        "status": [1],
...
function defineCustomElement() {
    ...
    const components = ["bh-avatar"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-avatar":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhAvatar);
            }
            break;
    } });
}
...
//# sourceMappingURL=p-YJm8-pxX.js.map
