...
const BhChartTooltip = /*@__PURE__*/ proxyCustomElement(class BhChartTooltip extends H {
    ...
    static get style() { return bhChartTooltipCss; }
}, [769, "bh-chart-tooltip", {
        "visible": [4],
        "x": [2],
        "y": [2],
        "header": [1],
        ...
        "storybookMode": [4, "storybook-mode"]
    }]);
function defineCustomElement() {
    if (typeof customElements === "undefined") {
        return;
    }
    const components = ["bh-chart-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-chart-tooltip":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhChartTooltip);
            }
            break;
    } });
}
...
export { BhChartTooltip as B, defineCustomElement as d };
//# sourceMappingURL=p-BLRNfy0t.js.map
