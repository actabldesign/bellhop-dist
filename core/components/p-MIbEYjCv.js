...
const BhLabel = /*@__PURE__*/ proxyCustomElement(class BhLabel extends H {
    ...
    static get style() { return bhLabelCss; }
}, [769, "bh-label", {
        "label": [1],
        "layout": [1],
        "for": [1],
...
function defineCustomElement() {
    ...
    const components = ["bh-label", "bh-tooltip"];
    components.forEach(tagName => { switch (tagName) {
        case "bh-label":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, BhLabel);
            }
            break;
        case "bh-tooltip":
            if (!customElements.get(tagName)) {
...
//# sourceMappingURL=p-MIbEYjCv.js.map
