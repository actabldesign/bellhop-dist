...
const BhMonthPickerContent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '7b5bd2302804839e5362752f0e1a54dd2698c1b7' }, index.h("div", { key: 'a71768e29f2c703f6b0ddfd84a392ae084182b9f', class: `month-picker-content animate-slide-up-enter ${this.scrollable ? 'scrollable' : ''}`, style: { height: this.height }, onKeyDown: this.handleKeyDown, onMouseDown: this.handleMouseDown }, index.h("div", { key: '3754d5452f0d4952e61f6bb0968c712f725466b1', class: "calendar" }, years.map((year, yearIndex) => (index.h("div", { key: year, class: "year-section", id: `year-${year}` }, index.h("div", { class: "year-month-container" }, index.h("div", { class: "year-label" }, year), index.h("div", { class: "months-row" }, index.h("div", { class: "month-row" }, this.months.slice(0, 6).map((_, monthIndex) => (index.h("button", { key: monthIndex, class: this.getMonthButtonClasses(monthIndex, year), disabled: !this.isMonthSelectable(monthIndex, year), onClick: () => this.selectMonth(monthIndex, year) }, this.months[monthIndex])))), index.h("div", { class: "month-row" }, this.months.slice(6, 12).map((_, idx) => {
            const monthIndex = idx + 6;
            return (index.h("button", { key: monthIndex, class: this.getMonthButtonClasses(monthIndex, year), disabled: !this.isMonthSelectable(monthIndex, year), onClick: () => this.selectMonth(monthIndex, year) }, this.months[monthIndex]));
        })))), yearIndex < years.length - 1 && (index.h("div", { class: "section-divider" }, index.h("div", { class: "divider-container" }, index.h("div", { class: "divider-line" })))))))))));
    }
    static get watchers() { return {
        "value": ["handleValueChange"],
        "selectedMonth": ["handleSelectedMonthChange"],
        "selectedYear": ["handleSelectedYearChange"]
    }; }
};
BhMonthPickerContent.style = bhMonthPickerContentCss;

exports.bh_month_picker_content = BhMonthPickerContent;
//# sourceMappingURL=bh-month-picker-content.entry.cjs.js.map
