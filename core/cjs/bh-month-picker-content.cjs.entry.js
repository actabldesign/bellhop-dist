...
const BhMonthPickerContent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'aa0bf635ddc8fffb3d21e705595e87ce4a60acea' }, index.h("div", { key: '0df1d3fed84f43c412e3c66becc237cdc5b8def0', class: `month-picker-content animate-slide-up-enter ${this.scrollable ? 'scrollable' : ''}`, style: { height: this.height }, onKeyDown: this.handleKeyDown, onMouseDown: this.handleMouseDown }, index.h("div", { key: '9745606dcf1196dd106f982beacd24ee6f16edaf', class: "calendar" }, years.map((year, yearIndex) => (index.h("div", { key: year, class: "year-section", id: `year-${year}` }, index.h("div", { class: "year-month-container" }, index.h("div", { class: "year-label" }, year), index.h("div", { class: "months-row" }, index.h("div", { class: "month-row" }, this.months.slice(0, 6).map((_, monthIndex) => (index.h("button", { key: monthIndex, class: this.getMonthButtonClasses(monthIndex, year), disabled: !this.isMonthSelectable(monthIndex, year), onClick: () => this.selectMonth(monthIndex, year) }, this.months[monthIndex])))), index.h("div", { class: "month-row" }, this.months.slice(6, 12).map((_, idx) => {
