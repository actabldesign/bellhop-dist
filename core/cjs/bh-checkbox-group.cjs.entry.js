...
const BhCheckboxGroup = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '14f895b1d0b5d6ba32a67ce3651c327d29d0770c' }, index.h("div", { key: '13b9e0179910941c223643945735fb66b699c6eb', class: "checkbox-group", role: role, "aria-disabled": this.disabled ? 'true' : null }, index.h("slot", { key: '6b28955878dca08ac7549e31130eb69a0880f2ae' }))));
    }
};
BhCheckboxGroup.style = bhCheckboxGroupCss;

exports.bh_checkbox_group = BhCheckboxGroup;
//# sourceMappingURL=bh-checkbox-group.entry.cjs.js.map
