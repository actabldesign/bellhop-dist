...
const BhPageNavigationMultiLevel = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.bhToggle = index.createEvent(this, "bhToggle");
        this.bhChildClick = index.createEvent(this, "bhChildClick");
        this.bhAddClick = index.createEvent(this, "bhAddClick");
    }
    /**
    ...
    render() {
        return (index.h(index.Host, { key: '15c1b2bbe0ddf13eb25d424ce7c60b281547175e' }, index.h("div", { key: '6a2ab39d69b4dc007c52cc0af63f39b4f8bf4ee8', class: this.getItemClasses() }, index.h("div", { key: '3796f0b3fad7ef3f0fd29bc8b8e90738b5165bbf', class: "page-navigation-multi-level-parent", onClick: this.handleParentClick, onMouseEnter: () => (this.isHovered = true), onMouseLeave: () => (this.isHovered = false) }, index.h("div", { key: '5ae04be6a630fcf8f1f25245ee8e8f5bfde6e27e', class: "page-navigation-item-content" }, !this.isHovered && (index.h("span", { key: 'e3893980a51628c19f2667d4cbd76958d1b67cff', class: "page-navigation-item-icon material-symbols-outlined" }, this.icon)), this.isHovered && (index.h("span", { key: '4429219610bf3dbeb1de38ef6f4b3734b3f521da', class: {
                'page-navigation-chevron-icon': true,
                'material-symbols-outlined': true,
                'expanded': this.isExpanded,
            } }, "expand_more")), index.h("span", { key: '4a81f12b1b2e0ec1e0784858f99845ad4dc3aa62', class: "page-navigation-item-label" }, this.label), index.h("bh-button", { key: 'bcadba2dff591857aafaaa434d06e97b0727b635', hierarchy: "tertiary", icon: "only", size: "xs", iconName: "add", onClick: this.handleAddClick }))), (this.isExpanded || this.isAnimating) && (index.h("div", { key: 'd99ed38a4fe97757f660c281b6e34c36f6837d87', class: `page-navigation-children ${this.animationClass}` }, this.childItems.map((child, index$1) => (index.h("bh-page-navigation-child", { key: index$1, label: child.label, badge: child.badge, showBadge: child.showBadge, isActive: child.isActive, onBhItemClick: () => this.handleChildClick(index$1) }))))))));
    }
    static get watchers() { return {
        "isExpanded": ["handleExpandedChange"]
    }; }
};
BhPageNavigationMultiLevel.style = bhPageNavigationMultiLevelCss;
...
const BhPageNavigationSingleLevel = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
    ...
    render() {
        return (index.h(index.Host, { key: '5387b77b73fdc815daea9186650806bde7df23aa' }, index.h("div", { key: '8ce567faedcab4229e8255b4641d226e48b689ba', class: this.getItemClasses(), onClick: () => this.handleClick() }, index.h("div", { key: 'e7cc690ae45617f1c0a52553b8e10dee57862d8a', class: "page-navigation-item-content" }, index.h("span", { key: '3ae6648a0b4e96851548299c0a40cd71d020e476', class: "page-navigation-item-icon material-symbols-outlined" }, this.icon), index.h("span", { key: '005a1932186fb40b2fc31f8d5f77a97c73da989e', class: "page-navigation-item-label" }, this.label)))));
    }
};
BhPageNavigationSingleLevel.style = bhPageNavigationSingleLevelCss;

exports.bh_page_navigation_multi_level = BhPageNavigationMultiLevel;
exports.bh_page_navigation_single_level = BhPageNavigationSingleLevel;
//# sourceMappingURL=bh-page-navigation-multi-level.bh-page-navigation-single-level.entry.cjs.js.map
