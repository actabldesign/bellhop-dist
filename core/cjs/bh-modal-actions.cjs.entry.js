...
const BhModalActions = class {
    ...
    renderButtons() {
        ...
        const primaryButton = this.destructive ? (index.h("button", { class: "btn-destructive", onClick: this.handlePrimaryAction, type: "button" }, this.primaryLabel)) : (index.h("bh-button", { hierarchy: "primary", icon: "none", size: "md", label: this.primaryLabel, onBhClick: this.handlePrimaryAction }));
        const secondaryButton = (index.h("bh-button", { hierarchy: "secondary", icon: "none", size: "md", label: this.secondaryLabel, onBhClick: this.handleSecondaryAction }));
        if (isRightAligned) {
            return (index.h("div", { class: "modal-actions-content modal-actions-content--right" }, index.h("div", { class: "actions-left" }, index.h("slot", { name: "left-content" })), index.h("div", { class: "actions-right" }, secondaryButton, primaryButton)));
        }
        // Full width buttons (stacks vertically on mobile via CSS)
        return (index.h("div", { class: "modal-actions-content modal-actions-content--fill" }, secondaryButton, primaryButton));
    }
    render() {
        return (index.h(index.Host, { key: 'fa07c24fee15053743650dfe99ee671eecdbf8e3' }, index.h("div", { key: 'e3d48c9e12aad9b55c745b23b641a6e96db662c4', class: "modal-actions" }, this.divider && index.h("div", { key: '89997127609e3a888b25be6a39654b264db8d785', class: "divider" }), this.renderButtons())));
    }
};
BhModalActions.style = bhModalActionsCss;

exports.bh_modal_actions = BhModalActions;
//# sourceMappingURL=bh-modal-actions.entry.cjs.js.map
