...
const BhPageNavigation = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'd55ac36c9c2b0363613add845ea76ace4fac3f2d' }, index.h("div", { key: 'cbd7fdd5a4e1319a20b741698541d88e6b5a2c10', class: "page-navigation" }, index.h("div", { key: '01e66276c629dd06abf13c416a2c48f1e6ebdabb', class: "page-navigation-header" }, index.h("h2", { key: '726a13dd5d418763934523d4ad76838ed5961e09', class: "page-navigation-title" }, this.navTitle)), index.h("nav", { key: '6bc70d426691b4f979aa5eb4b190cf146142b918', class: "page-navigation-list" }, this.items.map(item => item.type === 'single' ? (index.h("bh-page-navigation-single-level", { key: item.id, label: item.label, icon: item.icon, isActive: item.isActive || false, onBhItemClick: () => this.handleSingleLevelClick(item.id) })) : (index.h("bh-page-navigation-multi-level", { key: item.id, label: item.label, icon: item.icon, childItems: item.children || [], isExpanded: item.isExpanded || false, onBhToggle: () => this.handleMultiLevelToggle(item.id), onBhChildClick: (e) => this.handleMultiLevelChildClick(item.id, e.detail) })))))));
    }
    static get watchers() { return {
        "navigationItems": ["handleNavigationItemsChange"]
    }; }
};
BhPageNavigation.style = bhPageNavigationCss;

exports.bh_page_navigation = BhPageNavigation;
//# sourceMappingURL=bh-page-navigation.entry.cjs.js.map
