...
const BhDateRangePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: '08aacf3080c26252ad9016db0239f6ec59e18464' }, index.h("div", { key: 'ead0f755f1068c1a6b66d13b3499c0eb3dc79a81', class: "date-range-picker-container" }, this.variant === 'dropdown-outlined' && (index.h("div", { key: '18aa33151bafd73fc7bd8cb5f37226d7946782c3', class: "date-range-picker-trigger", onClick: this.handleTriggerClick }, index.h("bh-button", { key: 'dd1a3bdf7b1a3fa48717cf3d6ae56bc5c9523821', hierarchy: "secondary", size: "sm", icon: "trailing", label: this.getButtonLabel(), iconName: "expand_more", disabled: this.disabled }))), this.variant === 'dropdown-ghost' && (index.h("div", { key: 'c569af65f4722055339711fe824c845b7f9199b4', class: "date-range-picker-trigger", onClick: this.handleTriggerClick }, index.h("bh-button", { key: 'd23bc5b104c6bd0b1c5bb8453e390805ab50df4e', hierarchy: "tertiary", size: "sm", icon: "trailing", label: this.getButtonLabel(), iconName: "expand_more", disabled: this.disabled }))), this.variant === 'input' && (index.h("div", { key: '2a238184c8446070517f80142ef9871f45d7a0a5', class: "date-range-picker-trigger" }, index.h("div", { key: '2def41d08a9b0d0e94ebff478ca74a89ba2587ca', class: "date-range-inputs", onClick: this.handleTriggerClick }, index.h("bh-input-text", { key: 'be1917751e940c2bc66a6f0c3d1b558a7d26ae60', label: this.startLabel, placeholder: this.startPlaceholder, value: this.formatDate(this.selectedValue?.startDate || null), disabled: this.disabled, showTrailingIcon: true, trailingIcon: "calendar_today", showHelpIcon: false, showHintText: false, showLabel: this.showLabel, width: this.inputWidth, readOnly: true }), index.h("bh-input-text", { key: '34f7c3b5ba5a528e15b88813374cb82964b1faee', label: this.endLabel, placeholder: this.endPlaceholder, value: this.formatDate(this.selectedValue?.endDate || null), disabled: this.disabled, showTrailingIcon: true, trailingIcon: "calendar_today", showHelpIcon: false, showHintText: false, showLabel: this.showLabel, width: this.inputWidth, readOnly: true })))), index.h("div", { key: '614f36cc1e0f2161ecdc071874949f914bfa4cb9', class: "date-range-picker-menu-container" }, index.h("bh-picker-menu", { key: '9a1fdc35f823cb14900a8085a5a566b5458aebfb', visible: this.isMenuOpen, showFooter: this.showFooter, disableApply: this.showFooter && (!this.tempSelection?.startDate || !this.tempSelection?.endDate), onBhCancel: this.handleMenuCancel, onBhApply: this.handleMenuApply }, index.h("bh-date-range-picker-content", { key: 'b15f784587af73c62aad69893cbf04c822c96136', minYear: this.minYear, maxYear: this.maxYear, disabled: this.disabled, disabledDates: this.disabledDates, showOtherMonthDays: this.showOtherMonthDays, value: this.tempSelection ?? this.selectedValue ?? undefined })))), (this.isMenuOpen || this.isMenuClosing) && (index.h("div", { key: '754601e50f509ba5032f8e915807f3835d25c6ff', class: "date-range-picker-backdrop", onClick: this.handleBackdropClick }))));
    }
