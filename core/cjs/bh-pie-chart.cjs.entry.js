...
const BhPieChart = class {
    ...
    render() {
        ...
        const innerRadius = this.getInnerRadius();
        return (index.h(index.Host, { key: '6e08d27c86b66d352cb0af60a7c53a50bbfdbb68' }, index.h("div", { key: '6ea7a66cc1294f69e2757f54ace875ebd08613ed', class: "pie-chart-container", style: { width: `${this.size}px`, height: `${this.size}px` } }, index.h("svg", { key: 'd777cd322d93bf0d419213b87729c2cb94346362', width: this.size, height: this.size, viewBox: "0 0 160 160", class: "pie-chart-svg" }, index.h("circle", { key: 'bb77a5913fb0d8a849d27bf1e854c1f1ae690c4d', cx: "80", cy: "80", r: "80", fill: "transparent", class: "pie-background" }), segments.map((segment, index$1) => (index.h("g", { key: index$1, class: "pie-segment-group" }, index.h("path", { d: segment.path, fill: segment.color, class: { 'pie-segment': true, animated: this.animated }, style: { animationDelay: this.animated ? `${index$1 * 0.03}s` : '0s' }, onMouseEnter: (e) => this.handleSegmentHover(e, segment), onMouseLeave: this.handleSegmentLeave })))), this.hole !== 'none' && (index.h("circle", { key: '00e9cc73e53b04d9cee1df1bcdb2c7b1a2dad5b9', cx: "80", cy: "80", r: innerRadius, fill: "white", class: "pie-inner-hole" })))), index.h("bh-chart-tooltip", { key: 'a6c2652bf3c556ea6aaa5f8fcd2963abdc8322f6', visible: this.tooltipVisible, x: this.tooltipX, y: this.tooltipY, items: this.tooltipSegment
                ? [
                    {
