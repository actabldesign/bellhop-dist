...
const BhPopover = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a7558db0c7b23e4ec142ec3ec5e37e5e43ecaf3c' }, index.h("div", { key: '096623edfec8b24ce671855023676ba9e724141c', class: "popover", style: { width: this.width } }, index.h("div", { key: '901ff94955110af56d627e145784771975b3b5f8', class: "popover-content" }, index.h("div", { key: '0948fe57cdbbed592c5f93e8b12536c501cd5e27', class: "popover-menu" }, this.showAvatar && (index.h("div", { key: '6d0cb4e23fc4ceda1dd68b5d89216c6e50c4c18a', class: "popover-header" }, index.h("div", { key: '9411bf1f7ada776fe571db95648bb0805e627ede', class: "avatar-group" }, index.h("div", { key: '5408e5fd2506587cc6fd4899f83094441101dfc3', class: "avatar" }, this.avatarSrc ? (index.h("img", { src: this.avatarSrc, alt: this.popoverTitle, class: "avatar-image" })) : (index.h("slot", { name: "avatar" }))), index.h("div", { key: '9b30791b5bb664c7fcdcf10799b133fa649da830', class: "brand-info" }, index.h("div", { key: 'cc2304d4e9189485ac3e7f7f7a7bf3b321f99f16', class: "brand-name" }, this.popoverTitle), this.viewPortfolioText && (index.h("button", { key: 'b3b002ebf605618453618cfdb773c35b3355011a', class: "portfolio-link", onClick: this.handlePortfolioClick, type: "button" }, this.viewPortfolioText)))))), this.showSearch && (index.h("div", { key: '04798ef99a65da73afbe794250a11dec659868ed', class: "search-container" }, index.h("div", { key: 'e90f1d2137036da8ba4ad8b02d747892958164c3', class: "search-input" }, index.h("div", { key: '0efa8b359b1b523c2afd3dc26aa86ce3c86c38f7', class: "search-content" }, index.h("span", { key: '90d4054abc0c3bb758b3a43b0e21835609ac3b5e', class: "material-symbols-outlined search-icon" }, "search"), index.h("input", { key: 'abfd05266b12e5599ff3d7c3c79af659e5085584', type: "text", placeholder: this.searchPlaceholder, value: this.searchTerm, onInput: this.handleSearchInput, class: "search-field" }))))), index.h("div", { key: '82906cd547356049aa9a7541b89152e1a8268cb5', class: "menu-items" }, items.map((item) => (index.h("div", { key: item.id }, item.type === 'header' && (index.h("div", { class: "menu-header" }, item.label)), item.type !== 'header' && (index.h("div", { class: "menu-item-container" }, index.h("button", { class: this.getItemClasses(item), onClick: () => this.handleItemClick(item), type: "button" }, item.label))))))))))));
    }
};
BhPopover.style = bhPopoverCss;

exports.bh_popover = BhPopover;
//# sourceMappingURL=bh-popover.entry.cjs.js.map
