...
const BhChartTooltip = class {
    ...
    storybookMode = false;
    render() {
        return (index.h(index.Host, { key: '57397b8dd557ccf795a68896c7f1913fb0bc9b9e' }, index.h("div", { key: 'ff10c37825a1b62a08b168248b7d05b49fca5a79', class: {
                'chart-tooltip': true,
                ...
                left: `${this.x}px`,
                top: `${this.y}px`,
            } }, index.h("div", { key: '1eec265888955e2d073b85c4e2a5cde44b816233', class: "tooltip-content" }, this.header && index.h("div", { key: 'b287d571062079c274941e20863562898e1de7de', class: "tooltip-header" }, this.header), index.h("div", { key: 'f4db62e0a0bc52422546fff47e0fb11abffdf744', class: "tooltip-items" }, this.items.map((item, index$1) => (index.h("div", { key: index$1, class: "tooltip-item" }, item.color && (index.h("span", { class: "tooltip-dot", style: { backgroundColor: item.color } })), item.label && (index.h("span", { class: "tooltip-label" }, item.label, ":")), index.h("span", { class: "tooltip-value" }, item.value))))), this.showTotal && this.total && (index.h("div", { key: '46ade21e6d662ae224d6e2d019609b270b8e1989', class: "tooltip-total" }, index.h("span", { key: '8ad8d17c70c5b9a4a6fd98b54db5da98e9025875', class: "total-label" }, "Total:"), index.h("span", { key: '57e0ee054526971a7e4b8b8e43b2e0c1b685b9e4', class: "total-value" }, this.total)))))));
    }
};
BhChartTooltip.style = bhChartTooltipCss;

exports.bh_chart_tooltip = BhChartTooltip;
//# sourceMappingURL=bh-chart-tooltip.entry.cjs.js.map
