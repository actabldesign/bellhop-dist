...
const BhDatePickerContent = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '05d0441dcd2da1aa127579d04800747af79f067c' }, index.h("div", { key: '81eb39026a6e82623d1ec48654acf5aaacb84468', class: "date-picker-content" }, index.h("div", { key: 'ef803f98eb4d0d470f958a792af22bc2e7b1b541', class: "month-navigation" }, index.h("bh-button-icon", { key: '8b79154fe6a5464fd33573af8f1472673d16d4cf', hierarchy: "tertiary", size: "md", iconName: "chevron_left", onBhClick: this.handlePreviousMonth, disabled: this.disabled || (this.currentYear === this.minYear && this.currentMonth === 0) }), index.h("bh-button", { key: 'a90b1f7a5a86d934fb4c6a97f2dd89ea0dd22595', hierarchy: "tertiary", size: "sm", label: currentMonthYear, icon: "trailing", iconName: "expand_more", onBhClick: this.handleMonthDropdownToggle }), index.h("bh-button-icon", { key: 'e7c3d18fa4c1259c7e42cab0849ccf22467ff965', hierarchy: "tertiary", size: "md", iconName: "chevron_right", onBhClick: this.handleNextMonth, disabled: this.disabled || (this.currentYear === this.maxYear && this.currentMonth === 11) })), !this.isMonthDropdownOpen && (index.h("div", { key: '7ba8e5495cd893e9b4cd4b2fddfcde9645d95887', class: "calendar-grid" }, index.h("div", { key: '748139e26896df2b02cf304d17079cbfa207af38', class: "day-names" }, this.dayNames.map(dayName => (index.h("div", { key: dayName, class: "day-name" }, dayName)))), index.h("div", { key: '1bda4addff260424ef223cae08120fbd9d94720d', class: "date-cells" }, this.calendarCells.map((cell, index$1) => (index.h("div", { key: index$1, class: this.getCellClass(cell), onClick: () => this.handleCellClick(cell) }, index.h("span", { class: "date-number" }, cell.day === 0 ? '' : cell.day))))))), (this.isMonthDropdownOpen || this.isMonthDropdownClosing) && (index.h("div", { key: 'fe0d53f2a5a7d659cd0b8c5e231c4b4a3e4e45e5', class: `month-picker-inline ${this.isMonthDropdownClosing ? 'animate-fade-out' : ''}` }, index.h("bh-month-picker-content", { key: '22caaad16ffbf2f3bd40044290e6e663fde6ee1a', scrollable: true, height: "275px", selectedMonth: this.currentMonth, selectedYear: this.currentYear, onBhChange: this.handleMonthYearSelect, minYear: this.minYear, maxYear: this.maxYear }))))));
    }
...
const BhPickerMenu = class {
    constructor(hostRef) {
        ...
        this.bhCancel = index.createEvent(this, "bhCancel");
        this.bhApply = index.createEvent(this, "bhApply");
        this.bhToday = index.createEvent(this, "bhToday");
    }
    /**
     * Minimum year in the picker
     */
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("div", { class: menuClasses }, index.h("slot", null, index.h("bh-month-picker-content", { minYear: this.minYear, maxYear: this.maxYear, disabled: this.disabled, disabledMonths: this.disabledMonths, scrollable: true, selectedMonth: this.selectedMonth ?? undefined, selectedYear: this.selectedYear ?? undefined, onBhChange: this.handleMonthYearSelect })), this.showFooter && (index.h("div", { class: "picker-menu-footer" }, index.h("div", { class: `picker-menu-actions ${this.showTodayButton ? 'has-today-button' : ''}` }, this.showTodayButton && (index.h("bh-button", { hierarchy: "secondary", size: "sm", icon: "only", iconName: "today", onBhClick: this.handleToday })), index.h("div", { class: "picker-menu-main-actions" }, index.h("bh-button", { hierarchy: "secondary", size: "sm", label: "Cancel", onBhClick: this.handleCancel }), index.h("bh-button", { hierarchy: "primary", size: "sm", label: "Apply", disabled: this.disableApply, onBhClick: this.handleApply }))))))));
    }
    static get watchers() { return {
...
exports.bh_picker_menu = BhPickerMenu;
//# sourceMappingURL=bh-date-picker-content.bh-picker-menu.entry.cjs.js.map
