...
const BhCheckboxGroupItem = class {
    constructor(hostRef) {
        ...
        this.bhItemChange = index.createEvent(this, "bhItemChange");
    }
    /**
    ...
    render() {
        ...
        const renderInput = () => {
            if (this.type === 'radio') {
                return (index.h("bh-radio-button", { size: this.size, selected: this.selected, disabled: this.disabled, value: this.value, name: this.name, onBhChange: this.handleRadioChange }));
            }
            ...
            return (index.h("bh-checkbox", { size: this.size, checked: isChecked, disabled: this.disabled, onBhChange: this.handleCheckboxChange }));
        };
        const renderIcon = () => {
            if (this.type === 'icon-simple' && this.icon) {
                return (index.h("bh-featured-icon", { size: "sm", icon: this.icon, color: "gray", iconStyle: "outlined" }));
            }
            return null;
        };
        const renderContent = () => (index.h("div", { class: "item-content" }, index.h("div", { class: "item-text-row" }, this.itemTitle && index.h("span", { class: "item-title" }, this.itemTitle), this.subtitle && index.h("span", { class: "item-subtitle" }, this.subtitle)), this.description && index.h("p", { class: "item-description" }, this.description)));
        return (index.h(index.Host, null, index.h("div", { class: containerClasses, onClick: this.handleClick, onKeyDown: this.handleKeyDown, onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave, onFocus: this.handleFocus, onBlur: this.handleBlur, tabIndex: this.disabled ? -1 : 0, role: this.type === 'radio' ? 'radio' : 'checkbox', "aria-checked": String(isActive), "aria-disabled": this.disabled ? 'true' : null }, this.type === 'icon-simple' ? (
...
exports.bh_checkbox_group_item = BhCheckboxGroupItem;
//# sourceMappingURL=bh-checkbox-group-item.entry.cjs.js.map
