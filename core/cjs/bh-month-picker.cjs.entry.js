...
const BhMonthPicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: '77c20fea8e71861d26593fcb3afd64f876e931d5' }, index.h("div", { key: 'ece0e373ba2cea3d047ee4477ac42b84f1bab9ef', class: "month-picker-container" }, this.variant === 'dropdown-outlined' && (index.h("div", { key: '132c98c10fce8bfa4039270311773b1f0d5926ed', class: "month-picker-trigger", onClick: this.handleTriggerClick }, index.h("bh-button", { key: 'd72bc5ff61db88e5cfdcb969e168f184e625f152', hierarchy: "secondary", size: "sm", icon: "trailing", label: this.getButtonLabel(), iconName: "expand_more", disabled: this.disabled }))), this.variant === 'dropdown-ghost' && (index.h("div", { key: '985eec13541d0c8732ef79abe78caef7cb50b01f', class: "month-picker-trigger", onClick: this.handleTriggerClick }, index.h("bh-button", { key: '6b7542db3a2ee4c929598551355ab837d1cd11c4', hierarchy: "tertiary", size: "sm", icon: "trailing", label: this.getButtonLabel(), iconName: "expand_more", disabled: this.disabled }))), this.variant === 'input' && (index.h("div", { key: '2a1af2defcfef007180a574a6a6be7528a602c0e', class: "month-picker-trigger input-field-container" }, index.h("bh-input-text", { key: '1dd3b9000e3822f29523d955f7b68ea1d591c6ef', label: this.label, placeholder: this.placeholder, value: this.getDisplayValue(), disabled: this.disabled, showTrailingIcon: true, trailingIcon: "calendar_month", showHelpIcon: false, showHintText: false, showLabel: this.showLabel, width: this.inputWidth, onBhFocus: this.handleInputFocus }), index.h("div", { key: 'de8c1be2dc221533ea2007565245074c0385c245', class: "calendar-icon-overlay", onClick: this.handleTriggerClick }))), index.h("div", { key: '8cf969bf9396944146d9b46fbe33e501b281c008', class: "month-picker-menu-container" }, index.h("bh-picker-menu", { key: '11f469f151d40a80f9f958ab149059605af15396', visible: this.isMenuOpen, minYear: this.minYear, maxYear: this.maxYear, disabled: this.disabled, disabledMonths: this.disabledMonths, showFooter: this.showFooter, value: this.tempSelection || this.selectedValue || undefined, onBhChange: this.handleMonthYearSelect, onBhMonthYearSelect: this.handleMonthYearSelect, onBhCancel: this.handleMenuCancel, onBhApply: this.handleMenuApply }))), (this.isMenuOpen || this.isMenuClosing) && (index.h("div", { key: '6ebc7ff0588eea979419d80883b5e5f83317fac7', class: "month-picker-backdrop", onClick: this.handleBackdropClick }))));
    }
