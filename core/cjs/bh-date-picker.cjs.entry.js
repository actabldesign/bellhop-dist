...
const BhDatePicker = class {
    ...
    render() {
        return (index.h(index.Host, { key: 'a802c8d0bf2a5e40c909a8980f160d47b4e7bbde' }, index.h("div", { key: '348e50ba916744ded6d348683b61129140fc2923', class: "date-picker-container" }, this.variant === 'dropdown-outlined' && (index.h("div", { key: 'c044d02c7e1377c5596283dc44368b8656a9e511', class: "date-picker-trigger", onClick: this.handleTriggerClick }, index.h("bh-button", { key: '0e298c804889426af639d955e747936728004ef0', hierarchy: "secondary", size: "sm", icon: "trailing", label: this.getButtonLabel(), iconName: "expand_more", disabled: this.disabled }))), this.variant === 'dropdown-ghost' && (index.h("div", { key: '862b2d55c32a1eb5063b44a495fdf93b0b4fcd80', class: "date-picker-trigger", onClick: this.handleTriggerClick }, index.h("bh-button", { key: '7573039c5ab7a356010e71a7ef4e37e3d7177b32', hierarchy: "tertiary", size: "sm", icon: "trailing", label: this.getButtonLabel(), iconName: "expand_more", disabled: this.disabled }))), this.variant === 'input' && (index.h("div", { key: '1f2dc7e7a932c76b3611fc090b9ee2c4637090a2', class: "date-picker-trigger input-field-container" }, index.h("bh-input-text", { key: 'f80ebc3d20ef711ee3b56031327b79395a609671', label: this.label, placeholder: this.placeholder, value: this.getDisplayValue(), disabled: this.disabled, showTrailingIcon: true, trailingIcon: "calendar_today", showHelpIcon: false, showHintText: false, showLabel: this.showLabel, width: this.inputWidth, onBhFocus: this.handleInputFocus }), index.h("div", { key: '7a6e32953de4a30b13a4fb0ae3c1ebdbaeab9303', class: "calendar-icon-overlay", onClick: this.handleTriggerClick }))), index.h("div", { key: '80ed5a884954d099a11fcf99f6f1e90584759116', class: "date-picker-menu-container" }, index.h("bh-picker-menu", { key: 'ac3fa6d95099990e9d4ac9a223944efd7e3f8d3d', visible: this.isMenuOpen, showFooter: this.showFooter, showTodayButton: this.showFooter, disableApply: this.showFooter && this.tempSelection === null, onBhCancel: this.handleMenuCancel, onBhApply: this.handleMenuApply, onBhToday: this.handleToday }, index.h("bh-date-picker-content", { key: '8b92b1356191b4a0a48ddaa2b7f581f9d3eb4ac8', minYear: this.minYear, maxYear: this.maxYear, disabled: this.disabled, disabledDates: this.disabledDates, showOtherMonthDays: this.showOtherMonthDays, value: this.tempSelection ?? this.selectedValue ?? undefined, onBhDateSelect: this.handleDateSelect })))), (this.isMenuOpen || this.isMenuClosing) && (index.h("div", { key: '155ee3b226bf3425575c63e4d233c3eecb47b243', class: "date-picker-backdrop", onClick: this.handleBackdropClick }))));
    }
...
//# sourceMappingURL=bh-date-picker.entry.cjs.js.map
