...
const BhPageNavigationChild = class {
    constructor(hostRef) {
    ...
    render() {
        return (index.h(index.Host, { key: '801f6ce9fa33bff82ae0572ca4233d62101bff5a' }, index.h("div", { key: 'b485e3a258658dadebda21a9f329bb676a737e6d', class: this.getItemClasses(), onClick: this.handleClick }, index.h("div", { key: '3cebeec1f7255591c5a2405198d65f7cc637fe02', class: "page-navigation-child-content" }, index.h("span", { key: '982dbda8defddf8a04cbd4831d68090816bb8228', class: "page-navigation-child-label" }, this.label), this.badge !== undefined && this.showBadge && (index.h("span", { key: '623a58963bbbbd94d5a2934165a4f5e821ef3a56', class: "page-navigation-child-badge" }, this.badge))))));
    }
};
BhPageNavigationChild.style = bhPageNavigationChildCss;

exports.bh_page_navigation_child = BhPageNavigationChild;
//# sourceMappingURL=bh-page-navigation-child.entry.cjs.js.map
