...
const BhPropertySwitcher = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'acbc21dd3af3bfe9fef74a34e89c212cd74751c5' }, index.h("div", { key: '39b5a9e97a2858534f11a37dc0f3a5ba92159337', ref: (el) => (this.switcherRef = el), class: containerClasses }, index.h("button", { key: 'c145f14ca4171755e1487a4aa4c411fd6b871d55', class: "property-selector", onClick: () => this.handleToggle(), "aria-expanded": this.isExpanded ? 'true' : 'false', "aria-label": `Property selector: ${displayName}` }, selectedProp && (index.h("span", { key: '028e958900c9091f67df8e2262fc0e62f8b76f1f', class: "material-symbols-outlined selector-icon" }, this.getPropertyIcon(selectedProp.type))), index.h("span", { key: 'd6838a7ec2abdb24b31dd720e6c6ed3eff80213a', class: "property-name" }, displayName), index.h("span", { key: '17de4b63b32f9309008897a25e81a4c5c5126fa7', class: "material-symbols-outlined expand-icon", "aria-label": this.isExpanded ? 'Collapse Options' : 'Expand Options' }, this.isExpanded ? 'unfold_less' : 'unfold_more')), this.isExpanded && (index.h("div", { key: 'e53dc331066b4999dcc132b8ace1f24fc48b79b8', class: "dropdown-panel" }, this.renderSearchInput(), index.h("div", { key: 'b6b591d56b4bd04452298d145029e4bc150c1537', class: "dropdown-content" }, this.grouped
