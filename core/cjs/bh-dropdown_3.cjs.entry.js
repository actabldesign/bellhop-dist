...
const BhDropdown = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '72b74114a40b815346fbac4bc318c1a8c521c3bb', class: containerClasses }, !this.showAvatar && (index.h("div", { key: 'b7c5750fd9541b41ef7d44f080f5d54c443f36b5', ref: (el) => (this.triggerRef = el) }, index.h("bh-button", { key: 'bb1261290773322b49f84247a11f154f5805d79f', hierarchy: this.buttonHierarchy, icon: this.isIconOnly ? 'only' : 'trailing', size: this.size, label: this.isIconOnly ? '' : this.label, iconName: this.isIconOnly ? this.iconName : 'expand_more', disabled: this.disabled, onClick: this.toggleDropdown }))), this.showAvatar && (index.h("div", { key: '0a160fb08b45336d5f7a6bd34869f46c5e3e60a4', ref: (el) => (this.triggerRef = el), class: avatarClasses, onClick: (e) => {
                if (!this.disabled) {
                    e.stopPropagation();
                    this.toggleDropdown();
                }
...
const BhLogoBox = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'cddf182854e6f8d264dd11f87ff837c116b4b749' }, index.h("div", { key: '592e2ba2a109d7c88ebd32718ba6e58bfa5fdc2f', class: logoBoxClasses }, index.h("div", { key: '219a43154e0e2d216beaf5c071d36a09bf6de8a9', ref: (el) => (this.logoActiveRef = el), class: "logo-active", onClick: this.handleLogoClick }, index.h("img", { key: '7e69029e9e9f70f6395f128b348a6592fcce6731', src: this.getLogoSrc(), alt: `${this.logoType} logo`, class: logoClasses })), index.h("div", { key: '81edc7607a9aceb72d32d790e948d347f50555dc', class: "logo-more-products" })), index.h("bh-product-switcher", { key: '17d181c5e33d7cc942433345cc8c88a5b1ef1671', isOpen: this.isOpen, anchorPosition: this.anchorPosition, products: this.products, onBhClose: this.handleClose, onBhProductSelect: this.handleProductSelect })));
    }
};
...
const BhNavItem = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '0d118945925ec1e60f16ef60ca3e913386578fa8', class: navItemClasses }, index.h("button", { key: '41b8753e8c5048614505e02688b8678993f1c8d1', class: "nav-item-button", "aria-label": this.label, type: "button", onClick: this.handleClick, onKeyDown: this.handleKeyDown, disabled: this.disabled, tabIndex: this.disabled ? -1 : 0 }, index.h("span", { key: 'bbd4414639535eabedf673412e57d5f3c83e3ddc', class: "material-symbols-outlined icon" }, this.icon)), index.h("p", { key: 'cb747ba8b73b5201c47bd66de61d2b9bf5bd8a95', class: "nav-item-label" }, this.label)));
    }
};
