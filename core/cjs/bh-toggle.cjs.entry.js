...
const BhToggle = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '59ea31ccba3b8a5d19d991728abfa832af696c22', class: wrapperClasses, part: "wrapper" }, index.h("div", { key: '6a379c430ad0132a7bea6d72e8eaf48eb3444a7e', class: switchClasses, onClick: this.handleToggle, onKeyDown: this.handleKeyDown, onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave, onFocus: this.handleFocus, onBlur: this.handleBlur, tabIndex: this.disabled ? -1 : 0, role: "switch", "aria-checked": this.checked ? 'true' : 'false', "aria-disabled": this.disabled ? 'true' : 'false', "aria-label": this.label || undefined, part: "switch" }, index.h("div", { key: '3e9914d0096f303fd19aa44881f8463b5846b1ed', class: buttonClasses, part: "button" })), this.showText && (this.label || this.supportingText) && (index.h("div", { key: '9e46745a9ed60dc29c4da37e503576b40ece91c6', class: "toggle-text" }, this.label && (index.h("span", { key: 'f53a5c4d6fe6a3c2904fd05bc54603128995099c', class: labelClasses }, this.label)), this.supportingText && (index.h("div", { key: '1e4d3e0d5ccdb230306e74692309ae837b0d5ec4', class: "toggle-supporting-text" }, this.supportingText))))));
    }
    static get formAssociated() { return true; }
};
BhToggle.style = bhToggleCss;

exports.bh_toggle = BhToggle;
//# sourceMappingURL=bh-toggle.entry.cjs.js.map
