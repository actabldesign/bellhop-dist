...
const BhModalHeader = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'ad20e958392104052271804fed2db19722ac8282' }, index.h("div", { key: 'a713c21457f52b822525b8f57d8271f1819aa38d', class: {
                'modal-header': true,
                'modal-header--center': isCenter,
                'modal-header--horizontal': isHorizontal,
            } }, index.h("div", { key: '626e7a67264004b50a277f30a097ab4a41b33928', class: {
                'modal-header-content': true,
                'modal-header-content--center': isCenter,
                'modal-header-content--horizontal': isHorizontal,
            } }, this.showIcon && this.icon && (index.h("bh-featured-icon", { key: 'edc15a401b9d2bbce19c0dfcb63101468fdb23a6', icon: this.icon, color: this.iconColor, size: "md", iconStyle: "outlined" })), index.h("div", { key: 'bedf14040ad14da23897c5ac9133f86cda0d65fd', class: {
                'modal-text-content': true,
                'modal-text-content--center': isCenter,
                'modal-text-content--horizontal': isHorizontal,
            } }, index.h("h3", { key: 'f75cef1870847f358d1d6ceb66d6f3908b0f253a', class: "modal-title" }, this.modalTitle), this.description && (index.h("p", { key: '9e2f1c87c13c9b8f2f9900dce153d3b7a59ddbd9', class: "modal-description" }, this.description)))), this.showCloseButton && (index.h("bh-button-icon", { key: '5c986a9d8d14ae4248231cac4b286f57cf75b5d6', class: "close-button", hierarchy: "quaternary", size: "sm", iconName: "close", ariaLabel: "Close modal", onBhClick: this.handleClose }))), this.paddingBottom && index.h("div", { key: 'ca8eb070067de8ce6915f449ddfccbdfaa898720', class: "padding-bottom" }), this.divider && index.h("div", { key: '54ccd33d77239a9a28240c6ef6adfcad0dc10956', class: "divider" })));
    }
};
BhModalHeader.style = bhModalHeaderCss;

exports.bh_modal_header = BhModalHeader;
//# sourceMappingURL=bh-modal-header.entry.cjs.js.map
