...
const BhProductSwitcher = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("div", { class: "product-switcher-backdrop", onClick: this.handleClose }), index.h("div", { ref: (el) => this.containerRef = el, class: containerClasses, style: {
                top: `${this.anchorPosition.top}px`,
                left: `${this.anchorPosition.left}px`,
            } }, index.h("div", { class: "product-switcher-popover" }, this.products.map((product) => {
            const itemClasses = {
                'product-item': true,
                'current': product.current || false,
            };
            return (index.h("div", { key: product.id, class: itemClasses, onClick: () => this.handleProductClick(product) }, index.h("div", { class: "product-icon-container" }, index.h("img", { src: product.logo, alt: `${product.name} logo`, class: "product-icon" })), index.h("div", { class: "product-info" }, index.h("div", { class: "product-name" }, product.name), index.h("div", { class: "product-description" }, product.description))));
        })))));
    }
};
BhProductSwitcher.style = bhProductSwitcherCss;

exports.bh_product_switcher = BhProductSwitcher;
//# sourceMappingURL=bh-product-switcher.entry.cjs.js.map
