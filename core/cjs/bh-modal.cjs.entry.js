...
const BhModal = class {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("div", { class: modalClasses, onClick: this.handleOverlayClick }, this.overlay && index.h("div", { class: "modal-overlay" }), index.h("div", { class: "modal", style: { maxWidth: MODAL_WIDTHS[this.width] } }, index.h("slot", { name: "header" }), index.h("slot", null), index.h("slot", { name: "actions" })))));
    }
};
BhModal.style = bhModalCss;

exports.bh_modal = BhModal;
//# sourceMappingURL=bh-modal.entry.cjs.js.map
