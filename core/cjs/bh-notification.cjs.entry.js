...
const BhNotification = class {
    ...
    render() {
        ...
        return (index.h("div", { key: '515c579b7f77846984dcb59b12c51714cd522c90', class: notificationClasses, role: "alert", part: "container" }, index.h("div", { key: '6fa7a5ff931a4a5c798364e20c3cc295fd974617', class: "notification-content" }, index.h("div", { key: '3720231fd305c2c93e8b4baef2fc93403fed8748', class: "notification-icon-wrapper" }, index.h("bh-featured-icon", { key: 'eafe7f9f29cc2dfaca9cfc116a033e1a62583af0', icon: this.getIconName(), color: this.getIconColor(), size: "sm", iconStyle: this.getIconStyle() })), index.h("div", { key: 'fc7ae04d183ba374eabd77b103351da1eb2bb0f0', class: "notification-text" }, index.h("div", { key: 'e3377410aa9c6463e468195c18311b3498a6cb7c', class: "notification-text-wrapper" }, this.notificationTitle && (index.h("h3", { key: 'f277e1461742af2a03484a7e1f326f1616c5e341', class: "notification-title" }, this.notificationTitle)), this.description && (index.h("p", { key: '76bbc3b8ae19325a3304abf2fec2a43459b75e4d', class: "notification-description" }, this.description))), (this.actionText || this.dismissText) && (index.h("div", { key: 'ea940be7065dc17a70c9783e65383b0b820f1064', class: "notification-actions" }, this.dismissText && (index.h("bh-button", { key: 'b5ec730be6f688456c5105475240b695d7805e4f', hierarchy: "quaternary", size: "sm", label: this.dismissText, icon: "none", onBhClick: this.handleDismiss })), this.actionText && (index.h("bh-button", { key: '22f5a5ffb96d978c884678047ec73252baca3338', hierarchy: "quaternary", size: "sm", label: this.actionText, icon: "none", onBhClick: this.handleAction })))))), this.dismissible && (index.h("button", { key: '65bf8f837739ce1216375d42d2cf00166f524135', class: "notification-close", onClick: this.handleClose, "aria-label": "Close notification" }, index.h("span", { key: '4e4040982feb853b3e2c20af1c948edd49e8c6fe', class: "material-symbols-outlined close-icon" }, "close")))));
    }
};
