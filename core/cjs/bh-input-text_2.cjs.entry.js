...
const BhInputText = class {
    ...
    render() {
        ...
        return (index.h("div", { key: 'f518e4c3140c3407e3f0ec864ddbe5e923ec6fdb', class: "input-wrapper", part: "wrapper", style: wrapperStyle }, index.h("bh-label", { key: 'b5d5afff678974697a617fe4753e445a37957a53', label: this.showLabel ? this.label : '', required: this.required, showHelpIcon: this.showHelpIcon, helpIconTooltip: this.helpIconTooltip, disabled: this.disabled, onBhHelpClick: this.handleHelpClick }, index.h("div", { key: '4254972b8386826b614928c210399d6e113b3d43', class: containerClasses, onMouseEnter: this.handleMouseEnter, onMouseLeave: this.handleMouseLeave }, index.h("div", { key: '7ed52780a55645b81eef2334914903045c3680cc', class: "input-content" }, this.showLeadingIcon && (index.h("span", { key: '6e870c8c4677d9d9f900298e8205f072f9024348', class: "material-symbols-outlined leading-icon" }, this.leadingIcon)), index.h("input", { key: '23579144195274ac413d24a5811d44e3ce072047', ref: (el) => (this.inputEl = el), type: this.type, class: "input-element", name: this.name, value: this.value, placeholder: this.placeholder, disabled: this.disabled, readOnly: this.readOnly, required: this.required, "aria-label": this.label, "aria-describedby": this.showHintText && this.hintText ? 'hint-text' : undefined, "aria-invalid": String(this.error), onInput: this.handleInput, onFocus: this.handleFocus, onBlur: this.handleBlur, part: "input" }), this.showTrailingIcon && (index.h("span", { key: '840dad44c2f5bc9060e5a09ff86e9aebfdb8d950', class: "material-symbols-outlined trailing-icon" }, this.trailingIcon))))), this.showHintText && this.hintText && (index.h("div", { key: '69dfc89a179b2672c0776e0bb75ceb957b9cb1e0', class: { 'hint-text': true, 'hint-error': this.error }, id: "hint-text" }, this.hintText))));
    }
...
//# sourceMappingURL=bh-input-text.bh-picker-menu.entry.cjs.js.map
